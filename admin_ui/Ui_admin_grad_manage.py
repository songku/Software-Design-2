...
# Form implementation generated from reading ui file 'd:\coding_programs\PythonPrograms\student_status_information\admin_ui\admin_grad_manage.ui'
#
...
class Ui_login(object):
    def setupUi(self, login):
        ...
        self.stu_info_tableWidget.setGeometry(QtCore.QRect(470, 110, 611, 561))
        ...
        self.grad_status_label = QtWidgets.QLabel(login)
        self.grad_status_label.setGeometry(QtCore.QRect(70, 610, 121, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.grad_status_label.setFont(font)
        self.grad_status_label.setObjectName("grad_status_label")
        self.grad_status_lineEdit = QtWidgets.QLineEdit(login)
        self.grad_status_lineEdit.setGeometry(QtCore.QRect(190, 620, 211, 51))
        self.grad_status_lineEdit.setText("")
        self.grad_status_lineEdit.setObjectName("grad_status_lineEdit")
    ...
    def retranslateUi(self, login):
        ...
        self.grad_status_label.setText(_translate("login", "状态："))
